...
import com.example.fitfo.databinding.FragmentDiscoverBinding
...
class DiscoverFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        cardView.setOnClickListener {
            val url = "https://play.google.com/store/apps/details?id=com.duolingo&pcampaignid=web_share" // Thay thế đường link mong muốn
